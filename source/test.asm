...
.EQU OFFSET_FOR_2 = $0109 ; saves the offset for counter 2 for storage in loop
.EQU BUZZER_2_SIZE = $010A ; Stores the size of Buzzer 2, for looping
.EQU BUZZER_2_CURRENT = $010B ; Stores the current position in the loop for Buzzer 2
.EQU BUZZER_2_OFFSETS = $010C ; Starting location for list of offsets for Buzzer 2
.cseg
.org 000000
...
begin: ; the beginning
	...
	;
	; set up counter 1
	ldi r20, $03 | (1<<WGM12); Setting clock select to clk/1024 from IO clock (16MHz >> ~16Khz) + WGM12 set high
